              ...
              <RegistrationInfo>
                ...
                <AutoColumn gap="12px">
                  ...
                  <TYPE.body color={'text3'}>
                    ...
                    Ether. ETH works as a platform for numerous other cryptocurrencies, as well as for the execution of
            ...
            <RegistrationCard as={Link} to={'/solana'}>
              ...
              <RegistrationInfo>
                ...
                <AutoColumn gap="12px">
                  ...
                  <TYPE.body color={'text3'}>
                    Solana is a highly functional open source project that banks on blockchain technology’s
                    permissionless nature to provide decentralized finance (DeFi) solutions. Solana was founded by
                    Anatoly Yakovenko, Greg Fitzgerald, Raj Gokal, etc. and launched in 2020.
                  </TYPE.body>
                </AutoColumn>
              </RegistrationInfo>
            </RegistrationCard>
            ...
            <RegistrationCard as={Link} to={'/bsc'}>
              ...
              <RegistrationInfo>
                ...
                <AutoColumn gap="12px">
                  ...
                  <TYPE.body color={'text3'}>
                    Binance Chain, which was renamed BNB Beacon Chain in 2022, was launched by Binance in April 2019.
                    Its primary focus is to facilitate fast, decentralized (or non-custodial) trading.
                  </TYPE.body>
                </AutoColumn>
              </RegistrationInfo>
            </RegistrationCard>
              ...
              <RegistrationInfo>
                ...
                <AutoColumn gap="12px">
                  ...
                  <TYPE.body color={'text3'}>
                    ...
                    popular blockchain for smart contracts. Avalanche was founded by Emin Gün Sirer and launched in
                    2019.
                  </TYPE.body>
                </AutoColumn>
              </RegistrationInfo>
              ...
              <RegistrationInfo>
                ...
                <AutoColumn gap="12px">
                  ...
                  <TYPE.body color={'text3'}>
                    ...
                    by leveraging the unique properties of blockchain technology. Litecoin was founded by Charlie Lee
